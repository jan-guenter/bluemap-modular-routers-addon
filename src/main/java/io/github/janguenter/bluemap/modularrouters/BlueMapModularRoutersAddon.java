...
package io.github.janguenter.bluemap.modularrouters;

import io.github.janguenter.bluemap.modularrouters.adapter.bluemap522.AdapterCompatibility;

import java.lang.reflect.InvocationTargetException;
import java.lang.reflect.Method;

/** BlueMap add-on entrypoint installed before resource-pack construction. */
public final class BlueMapModularRoutersAddon implements Runnable {
        ...
        try {
            ...
            Class<?> adapter = Class.forName(
                    "io.github.janguenter.bluemap.modularrouters.adapter.bluemap522."
                            + "BlueMap522Adapter",
                    true,
                    BlueMapModularRoutersAddon.class.getClassLoader()
            );
    ...
    private static void inactive(String reason, Throwable cause) {
        ...
        System.err.println("BlueMap Modular Routers add-on is inactive: " + reason + detail + ".");
    }
}
