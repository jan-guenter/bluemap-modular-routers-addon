...
- Correct propertyless `minecraft:glass` camouflage by consuming the exact
  released Glassential add-on's generated Fusion contextless cell-0 tile.
- Guard all 49 exact Glassential custom-renderer routes from ordinary raw-model
  rendering, with atomic stock-host fallback for unsupported or invalid routes.
